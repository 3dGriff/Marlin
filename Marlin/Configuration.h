/**
 * /**
 * Hooklet3d Odin One Branch
 * Copyright (C) 2016 Hooklet3D [https://hooklet3d.com/odin/firmware
 * 
...
#define CUSTOM_MACHINE_NAME "Odin One MK1"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "8305e682-bd43-441a-890c-f8cd27e69628"
...
#define HEATER_0_MINTEMP -14
#define HEATER_1_MINTEMP -14
#define HEATER_2_MINTEMP 5
#define HEATER_3_MINTEMP 5
#define BED_MINTEMP -14
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // These are the default PID settings for the Odin one, you should still conduct an autotune to set them
  // for your machine
